...
mist-versus-water identity remains unconfirmed. Louisiana Ghastly Bayou fails
because its water edge remains visibly jagged. Super Dreamland 64 and the remaining 11 maps are
ungraded.
...
| 2 | Louisiana Ghastly Bayou — **FAIL** | [proof](C:/Programming/GitHub/Vigilante-8-recomp/artifacts/v82-map-fidelity-current/review-proofs/bayou-current-enhanced.png) | [PS1 at 01:21](https://www.youtube.com/watch?v=awgSqlSw8b4&t=81s) | User reports that the water edge remains visibly jagged on the current Dreamcast-parity renderer. The correction must be a shared water-grid/shoreline/depth rule, not a Louisiana, cell, polygon, address, or authored-content exception. |
