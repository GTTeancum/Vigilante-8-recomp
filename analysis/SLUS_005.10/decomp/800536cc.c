...
code_r0x800536cc:
  ...
  if ((in_stack_00000210 >> 2 & 1) == 0) {
    ...
    pvVar3 = memchr(pbVar7,'\0',in_stack_00000218);
    uVar6 = (int)pvVar3 - (int)pbVar7;
    if (pvVar3 == (void *)0x0) {
      iVar2 = SPRINTF_OBJ_7A0();
      return iVar2;
    }
...
code_r0x800537a4:
  ...
  FUN_80044d9c(iVar2,pbVar7,uVar6);
...
SPRINTF_OBJ_794:
  ...
  while (uVar5 != 0) {
    pbVar7 = pbVar7 + -1;
    uVar6 = uVar6 + 1;
    *pbVar7 = (char)uVar5 + (char)(uVar5 / 10) * -10 + 0x30;
    uVar5 = uVar5 / 10;
  }
...
SPRINTF_OBJ_59C:
  ...
  for (; uVar5 != 0; uVar5 = uVar5 >> 4) {
    pbVar7 = pbVar7 + -1;
    uVar6 = uVar6 + 1;
    *pbVar7 = "0123456789abcdef"[uVar5 & 0xf];
  }
  for (; (int)uVar6 < in_stack_00000218; uVar6 = uVar6 + 1) {
    pbVar7 = pbVar7 + -1;
    *pbVar7 = 0x30;
