...

{
  ...
  if ((short)in_t0[3] < 0) {
    ...
    uVar3 = DAT_8006502a - 1;
    if ((int)(short)in_t0[3] <= DAT_8006502a + -1) {
      uVar1 = SYS_OBJ_1A88(in_t0[3]);
      return uVar1;
    }
  }
  in_t0[3] = uVar3;
  ...
  uVar2 = SYS_OBJ_219C(3);
  DAT_800a3324 = uVar2 | 0xe3000000;
  uVar2 = SYS_OBJ_219C(4);
  DAT_800a3328 = uVar2 | 0xe4000000;
  uVar2 = SYS_OBJ_219C(5);
  DAT_800a332c = uVar2 | 0xe5000000;
  uVar1 = SYS_OBJ_1BF8();
  return uVar1;
}
