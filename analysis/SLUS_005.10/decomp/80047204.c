...
void S_SVA_OBJ_480(undefined4 param_1,ushort param_2,ushort param_3)

{
  ...
  while( true ) {
    do {
      (&DAT_1f801c0a)[unaff_s3] = (&DAT_1f801c0a)[unaff_s3] & 0x3f | (param_2 | param_3) << 6;
      do {
        ...
        if ((unaff_s2 != 0) || ((unaff_s1 & 1) != 0)) {
          ...
          *(ushort *)(&VOICE_00_LEFT_RIGHT + unaff_s4 * 4) = uVar3 | uVar4;
        }
        if ((unaff_s2 != 0) || ((unaff_s1 & 2) != 0)) {
          ...
          *(ushort *)((int)&VOICE_00_LEFT_RIGHT + unaff_s4 * 0x10 + 2) = uVar3 | uVar4;
        }
        ...
        if ((unaff_s2 != 0) || ((unaff_s1 & 0x20000) != 0)) {
          (&VOICE_00_ADSR_ATT_DEC_SUS_REL)[unaff_s4 * 8] = *(word *)((int)unaff_s0 + 0x3a);
        }
        if ((unaff_s2 != 0) || ((unaff_s1 & 0x40000) != 0)) {
          (&DAT_1f801c0a)[unaff_s4 * 8] = (short)unaff_s0[0xf];
        }
        if ((unaff_s2 != 0) || ((unaff_s1 & 0x800) != 0)) {
          ...
          (&VOICE_00_ADSR_ATT_DEC_SUS_REL)[unaff_s4 * 8] =
               (&VOICE_00_ADSR_ATT_DEC_SUS_REL)[unaff_s4 * 8] & 0xff | (uVar4 | uVar3) << 8;
        }
        if ((unaff_s2 != 0) || ((unaff_s1 & 0x1000) != 0)) {
          ...
          (&VOICE_00_ADSR_ATT_DEC_SUS_REL)[unaff_s4 * 8] =
               (&VOICE_00_ADSR_ATT_DEC_SUS_REL)[unaff_s4 * 8] & 0xff0f | uVar4 << 4;
        }
      } while ((unaff_s2 == 0) && ((unaff_s1 & 0x2000) == 0));
      param_2 = (ushort)unaff_s0[0xd];
      if (0x7f < param_2) {
        param_2 = 0x7f;
      }
      param_3 = 0x100;
