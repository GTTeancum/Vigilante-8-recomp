...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/../../../V8_ARCADE_WORK/rexglue/generated/default/sources.cmake")
    include(../../../V8_ARCADE_WORK/rexglue/generated/default/sources.cmake)
    set(REXGLUE_ENTRYPOINT_GENERATED_SOURCES ${GENERATED_SOURCES})
    set(REXGLUE_ENTRYPOINT_INCLUDE_DIR "${CMAKE_CURRENT_SOURCE_DIR}/../../../V8_ARCADE_WORK/rexglue/generated/default")
endif()
...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/../../../V8_ARCADE_WORK/rexglue/generated/default/dll_targets.cmake")
    include(../../../V8_ARCADE_WORK/rexglue/generated/default/dll_targets.cmake)
endif()

# Codegen target - run 'cmake --build . --target v8_arcade_codegen'
# Uses the manifest to drive codegen for all modules (entrypoint + DLLs).
add_custom_target(v8_arcade_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/v8_arcade_manifest.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for v8_arcade"
    VERBATIM
)
